************************************************;
* creates regression output for Table 4;
* age price profile before and after election;
************************************************;
option ls=120;
Libname Convey 'C:\';
PROC IMPORT OUT= one 
...
Lincoln=0; if no_sale_date>mdy(11,6,1860) then lincoln=1;

proc sort; by lincoln;


ods csv file='C:\fig_4.csv';
